...
%P_vec(:,4*(horizon+1) - 3:4*(horizon+1)) = 0;
P_vec(:,4*(horizon+1) - 3:4*(horizon+1)) = [102.1527    0.8500   -0.0000   -0.0000;0.8500    1.4518   -0.0000   -0.0000;-0.0000   -0.0000  223.5099  198.6659;-0.0000   -0.0000  198.6659  443.5447];
A_vec = [];
B_vec = [];
